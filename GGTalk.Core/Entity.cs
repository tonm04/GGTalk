...
namespace GGTalk
{
    ...
    public class GGGroup : IGroup
    {
        ...
        {
            if (!this.ManagerList.Contains(userID))
            {
                this.ManagerList.Add(userID);
                this.Managers = ESBasic.Helpers.StringHelper.ContactString<string>(this.ManagerList, ",");
            }
        }

        public void RemoveManager(string userID)
        {
            this.ManagerList.Remove(userID);
            this.Managers = ESBasic.Helpers.StringHelper.ContactString<string>(this.ManagerList, ",");
        }
